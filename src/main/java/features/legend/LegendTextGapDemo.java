...
public class LegendTextGapDemo extends ChartSamplePanel
    ...
    protected void initComponents() {
        ...
        jSpinner1.setModel(new SpinnerNumberModel(30, 0, 100, 1));
        ...
        jSpinner2.setModel(new SpinnerNumberModel(14, 0, 100, 1));
        ...
        jSpinner3.setModel(new SpinnerNumberModel(2, -5, 30, 1));
