...
public class MovAveDemo extends ChartSamplePanel
    ...
    private void initSeries() {
        ...
        movingAve1Series = new Line(chart1.getChart());
        ...
        movingAve2Series = new Line(chart1.getChart());
        ...
        expAveSeries = new Line(chart1.getChart());
