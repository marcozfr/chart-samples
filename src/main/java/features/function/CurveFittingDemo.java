...
public class CurveFittingDemo extends ChartSamplePanel
    ...
    protected void initComponents() {
        ...
        /* Chart Components */
        dataSeries = new FastLine(chart1.getChart());
        dataSeries.fillSampleValues(200);
        dataSeries.setTitle("data");

        curve1Series = new FastLine(chart1.getChart());
        curve2Series = new FastLine(chart1.getChart());
        ...
        fitting1Function = new CurveFitting(chart1.getChart());
        ...
        fitting2Function = new CurveFitting();
