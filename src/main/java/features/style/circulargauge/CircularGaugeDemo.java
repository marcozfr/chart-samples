...
public class CircularGaugeDemo extends ChartSamplePanel
    ...
    protected void initComponents() {
        ...
        series.getFaceBrush().setForegroundColor(Color.BLUE);
        ...
        jOuter.setModel(new SpinnerNumberModel(series.getFrame().getFrameElementPercents()[2], 0, 100, 1));
        ...
        jMiddle.setModel(new SpinnerNumberModel(series.getFrame().getFrameElementPercents()[1], 0, 100, 1));
        ...
        jInner.setModel(new SpinnerNumberModel(series.getFrame().getFrameElementPercents()[0], 0, 100, 1));
        ...
        jWidth.setModel(new SpinnerNumberModel(30, 0, 100, 1));
