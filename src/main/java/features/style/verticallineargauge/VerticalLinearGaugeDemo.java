 ...
 * @author tom
 */
public class VerticalLinearGaugeDemo extends ChartSamplePanel
    ...
    public VerticalLinearGaugeDemo() {
        super();
    }
    ...
    protected void initComponents() {
        ...
        openAction = new OpenAction("Left Linear Gauge Editor");
        openAction2 = new OpenAction("Right Linear Gauge Editor");
